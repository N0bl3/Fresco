...
router.get('/', function (req, res, next) {
  ...
  console.log("Expected Dimensions:", WIDTH, HEIGHT, "Total pixels:", WIDTH * HEIGHT)
...
router.post('/change', function (req, res, next) {
  if (req.body.x >= 0 && req.body.y >= 0 && req.body.x < process.env.MAX_NUMBER_OF_PIXELS / req.body.y && req.body.y < process.env.MAX_NUMBER_OF_PIXELS / req.body.x) {
    const changedPixel = {
